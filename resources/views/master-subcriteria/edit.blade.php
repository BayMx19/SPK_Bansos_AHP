            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-bold">Edit Sub Kriteria</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="criteria_id" class="form-control" required>
                                            ...
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $subcriteria->criteria_id ? 'selected' : '' }}>
                                                {{ $item->nama }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sub_criteria"
                                            value="{{$subcriteria->sub_criteria}}" required>
                                    </div>
                                </div>
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="bobot"
                                            value="{{$subcriteria->bobot}}" required>
                                    </div>
                                </div>
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="nilai_prioritas"
                                            value="{{$subcriteria->nilai_prioritas}}" step="0.000001" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
